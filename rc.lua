...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,  }, "d",
    function ()
        awful.spawn(string.format("dmenu_run -i  -h '21' -nb '#1b1e2b' -nf '#a8b4ff' -sb '#c387ea' -sf '#1b1e2b' -shb '#1b1e2b' -shf '#a8b4ff' -fn 'JetBrains Mono:style=ExtraBold:size=10'"), false)
	end,
